...
const adapter = (handler, eventSchema = {}, contextSchema = {}) => middy(handler)
...
const adapterEvent = (handler, eventSchema = {}, contextSchema = {}) => middy(handler)
...
const adapterDynamoEvent = (handler, eventSchema = {}, contextSchema = {}) => middy(handler)
  .use(validatorMiddleware({ eventSchema, contextSchema }))
  .use(errorHandlerMiddleware())
  .use(injectLambdaContext(logger, { logEvent: false }))
  .use(logMetrics(metrics));
