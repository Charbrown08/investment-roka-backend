...
const tooManyRequest = (error) => (path = '/') => ({
  statusCode: 429,
  body: JSON.stringify({
...
const unprocessable = (error) => (path = '/') => ({
  statusCode: 422,
  body: JSON.stringify({
